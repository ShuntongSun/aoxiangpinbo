...
coco_pairs = [(1, 6), (2, 1), (3, 1), (4, 2), (5, 3), (6, 7), (7, 1), (8, 6), (9, 7), (10, 8),
              (11, 9), (12, 6), (13, 7), (14, 12), (15, 13), (16, 14), (17, 15)]
...
class Feeder(Dataset):
    ...
    def load_data(self):
        ...
        if self.data_split == 'train':
            ...
            # 检查是否存在 'y_test' 键
            if 'y_test' in npz_data:
                self.label = npz_data['y_test']
            else:
                self.label = None  # 如果没有 'y_test'，则将标签设为 None
    ...
    def __getitem__(self, idx: int) -> (torch.Tensor, torch.Tensor):
        ...
        label = self.label[idx] if self.label is not None else None  # 如果没有标签，设置为 None
    ...
    def top_k(self, score, top_k):
        rank = score.argsort()
        hit_top_k = [l in rank[i, -top_k:] for i, l in enumerate(self.label) if self.label is not None]
...
#     label = label.long() if label is not None else None  # B 1
#     print("pause")